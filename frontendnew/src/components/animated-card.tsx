...
export function AnimatedCard({ className, ...props }: CardProps) {
  return (
    <div
      ...
      className={cn(
        "group/animated-card relative w-[250px] overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-900 dark:bg-black",
...
export function CardVisual({ className, ...props }: CardProps) {
  return (
    <div
      className={cn("h-[150px] w-[250px] overflow-hidden", className)}
      {...props}
    />
  );
}
