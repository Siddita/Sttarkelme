              ...
              >
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 mb-2">
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <span className="text-xs sm:text-sm font-medium text-gray-900">Overall IDP Completion</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-base sm:text-lg font-bold text-blue-600">{idpCompletion}%</span>
                ...
                <div className="space-y-6 mt-4">
                  ...
                  <div className="p-4 bg-blue-50 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-xl sm:text-2xl font-bold text-blue-600">{idpCompletion}%</span>
                    </div>
