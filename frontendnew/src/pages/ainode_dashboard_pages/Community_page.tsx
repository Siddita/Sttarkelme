    ...
    <div className="space-y-4 sm:space-y-6 lg:pt-0 pt-12">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm sm:text-base text-gray-600 mt-1">Connect, learn, and grow with fellow professionals</p>
        </div>
      ...
      <Tabs defaultValue="discussions" className="space-y-6">
        ...
        <TabsContent value="discussions" className="space-y-4 sm:space-y-6">
          ...
          <div className="space-y-3 sm:space-y-4">
            {filteredDiscussions.map((discussion) => (
              <Card key={discussion.id} className="bg-white/80 backdrop-blur-sm shadow-lg border-0 rounded-xl sm:rounded-2xl hover:shadow-xl transition-all duration-300">
                <CardContent className="p-4 sm:p-6">
        ...
        <TabsContent value="mentors" className="space-y-4 sm:space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {mentors.map((mentor) => (
              <Card key={mentor.id} className="bg-white/80 backdrop-blur-sm shadow-lg border-0 rounded-xl sm:rounded-2xl hover:shadow-xl transition-all duration-300">
                <CardContent className="p-4 sm:p-6">
