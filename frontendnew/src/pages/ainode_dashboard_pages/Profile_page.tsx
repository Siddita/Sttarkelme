          ...
          <CardContent className="p-4 sm:p-6 pb-4">
            <div className="text-center space-y-3">
              <div className="relative">
                ...
                <Button
                  size="sm"
                  className="absolute bottom-0 right-1/2 translate-x-1/2 translate-y-2 bg-white shadow-lg rounded-full p-1.5 sm:p-2"
                >
        ...
        <div className="lg:col-span-2">
          <Tabs defaultValue="personal" className="space-y-4 sm:space-y-6">
            <TabsList className="grid w-full grid-cols-4 bg-white/80 backdrop-blur-sm rounded-xl sm:rounded-2xl p-1">
              <TabsTrigger value="personal" className="rounded-lg sm:rounded-xl text-xs sm:text-sm">
                Personal Info
              </TabsTrigger>
              <TabsTrigger value="skills" className="rounded-lg sm:rounded-xl text-xs sm:text-sm">
                Skills
              </TabsTrigger>
              <TabsTrigger value="achievements" className="rounded-lg sm:rounded-xl text-xs sm:text-sm">
                Achievements
              </TabsTrigger>
              <TabsTrigger value="goals" className="rounded-lg sm:rounded-xl text-xs sm:text-sm">
                Learning Goals
              </TabsTrigger>
            </TabsList>
              ...
              <Card className="bg-white/80 backdrop-blur-sm shadow-lg border-0 rounded-xl sm:rounded-2xl">
                <CardHeader className="p-4 sm:p-6">
                  <CardTitle className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 text-base sm:text-lg">
                    ...
                    <Button
                      size="sm"
                      className="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white rounded-xl text-xs sm:text-sm"
                    >
                      Add Goal
                    </Button>
                  </CardTitle>
